...
//static const char col_gray4[]       = "#f0ffff";
//static const char col_cyan[]        = "#006994";

// Blue theme colors
static const char col_fg_norm[]		= "#b0e0e6"; // Powder Blue
static const char col_fg_sel[]		= "#f0f8ff"; // Alice Blue
...
static const char *volume_mute[]  = { "togglevolume", NULL };
static const char *volume_down[]  = { "volumedown", NULL };
static const char *volume_up[]  = { "volumeup", NULL };
